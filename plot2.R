...
# plot the Date_time and the Global Active Power with lines
with(EletricData, plot(Date_time, Global_active_power, type = "l", xlab = "", ylab = "Global Active Power (kilowatts)"))
